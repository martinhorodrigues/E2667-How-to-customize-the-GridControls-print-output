...
Namespace MyXtraGrid
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.myGridView1.GroupFooterShowMode = DevExpress.XtraGrid.Views.Grid.GroupFooterShowMode.VisibleAlways
			...
			Me.myGridView1.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() { New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.gridColumn1, DevExpress.Data.ColumnSortOrder.Ascending)})
'			Me.myGridView1.CustomDrawFooterCell += New DevExpress.XtraGrid.Views.Grid.FooterCellCustomDrawEventHandler(Me.myGridView1_CustomDrawFooterCell);
			' 
			' gridColumn1
			' 
			...
			' simpleButton1
			' 
			Me.simpleButton1.Location = New System.Drawing.Point(575, 13)
